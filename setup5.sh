...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/Recycle/main/ins-xray5.sh && chmod +x ins-xray5.sh && screen -S ins-xray ./ins-xray5.sh
...
echo -e "\e[1;32m══════════════════ Autoscript By NevermoreSSH ══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
